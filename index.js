...
const RULES = {
  ...
  general: "القوانين العامة:\n1) الالتزام بالدور : يجب أن تتصرف شخصيتك في اللعبة كما لو كانت حقيقية ، أي لا تخرج عن الدور أو تتحدث عن أشياء خارج اللعبة (مثل قول اللعبة لاق أثناء مشهد RP) \n2) كسر الشخصية (Metagaming) : لا تستخدم معلومات حصلت عليها خارج اللعبة (مثل الديسكورد أو البثوث) داخل اللعبة \n3) يمنع القتل العشوائي (RDM) \n4) يمنع استخدام المركبات كسلاح (VDM) \n5) إجبار الدور التمثيلي (Powergaming ) : مثال إغلاق أي باب بالمركبة \n6) الهروب من السيناريوهات لا تخرج من اللعبة أثناء مشهد RP للهروب من الموقف (مثل الاعتقال أو الخسارة) \n7) في حال اسقطت يجب عليك التألم لا يمكنك الكلام بطلاقه فيجب عليك التصرف كما لو كنت مصاباً \n8) يمنع اهانة الشخص المسقط بأي حال من الأحوال \n9) يمنع تقليد ملابس الشرطة اوالاسعاف \n10) لا يحق لك تحريك الجثه الا بغرض المساعده \n11) يمنع التحلل في سيناريو قائم \n12) يمنع التدخل في سيناريو قائم \n13) الشخصنه ممنوعه منعا باتا بجميع انواعها \n14) يمنع منعا باتا استدراج الشرطة او خطف شرطي اثناء استيقاف مروري \n15) يمنع منعا باتا التعرض للمسعف مهما كانت الضروف ومن يخالف ذلك يعرضة الى الباند \n16) يمنع استخدام الجرافيكس والملفات الغير واقعيه بكل انواعها \n17) يمنع سرقة المعدات الشرطة أو الحكومية بـ جميع أنواعها \n18) يمنع التحدث بالسياسه والاعراض والدين وايضا المضايقات \n19) يمنع تقليد الكركترات والاسماء الموجوده بالسيرفر بأي طريقة كانت \n20) يمنع دخول البيت او الشقه اثناء السيناريو \n21) يمنع إرتداء او إستعمال اي خوذة اثناء مشاركتك في اي طلق ناري \n22) يمنع العودة للسيناريو بعد الإسقاط بأي شكل من الأشكال \n23) الكذب بالمسطلحات التالية { سحر او باخذ حبه او صداع والخ } يعرضك للمحاسبة الادارية \n24) عند حدوث اعادة تشغيل للسيرفر { اعصار } وكنت تحت رهن الاعتقال يجب عليك الرجوع وتسليم نفسك لمركز \n25) يجب الالتزام بالذوق العام في الملابس بشكل كامل \n26) لا يسمح بإرتداء عدة الغوص خارج البحر ومن يخالف ذلك سيتم محاسبته \n27) يمنع الإحتماء بالمناطق الأمنة \n28) يمنع تقليل الاحترام لأي لاعب أو السب والشتم و القذف لأي سبب من الاسباب ",
